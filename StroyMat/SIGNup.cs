    ...
    public partial class SIGNup : System.Windows.Forms.Form
    {
        ...
        private void btnSignUP_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("INSERT INTO People (Username, Password, Name, Surname) VALUES ('" + TextBoxUsername.Text + "', '" + TextBoxPassword.Text + "', '" + TextBoxUsername.Text + "', '" + TextBoxSurname.Text + "')", connection);
                    connection.Open();
                    cmd.ExecuteNonQuery();
                    connection.Close();   
